...
groq_client = Groq(api_key="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")
...
def generate_interview_questions(resume_text, job_description, experience_level, num_questions=5):
    ...
    for i in range(num_questions):
        ...
        4. Focus on theoretical skills mentioned in both resume and job description
        5. Be appropriate for the candidate's experience level
        6. Ask the user to explain one of its projects
        7. Only ask theoretical questions
        8. Don't mention "Here's a specific theory-based interview question for an entry-level candidate:"
